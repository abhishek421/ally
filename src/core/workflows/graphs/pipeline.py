...
from src.core.agents.registry.models import NextAction
...
class AnalystPipeline:
    ...
    def __init__(self, enable_reactive: bool = True, enable_orchestrator: bool = True):
        """
        Initialize pipeline
        ...
        self.enable_orchestrator = True  # Force orchestrator mode - legacy pipeline removed
